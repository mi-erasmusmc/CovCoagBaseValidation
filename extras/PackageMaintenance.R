...
OhdsiRTools::checkUsagePackage("CovCoagBaseValidation")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/CovCoagBaseValidation.pdf")
shell("R CMD Rd2pdf ./ --output=extras/CovCoagBaseValidation.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "CovCoagBaseValidation")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("CovCoagBaseValidation")
