...
Guide
============
A general guide for running a valdiation study package is available here: [Skeleton Validation Study guide](https://github.com/OHDSI/CovCoagBaseValidation/tree/master/inst/doc/UsingSkeletonValidationPackage.pdf)
...
projectFolder <- "C:/CovCoagBaseValidation"
...
download.file("https://raw.githubusercontent.com/ohdsi-studies/CovCoagBaseValidation/master/renv.lock", "renv.lock")
...
devtools::install_github("ohdsi-studies/CovCoagBaseValidation")
```
...
===============
  ...
  2. In R, run the code in 'extras/codeToRun.R' (see [Skeleton Validation Study guide](https://github.com/OHDSI/CovCoagBaseValidation/tree/master/inst/doc/UsingSkeletonValidationPackage.pdf) for guideance)
...
cohortTable <- 'CovCoagBaseValidationCohortTable'
